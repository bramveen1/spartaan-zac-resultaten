...
// field and re-apply pointsFor. Start numbers overlap across classes (#17 in
// A and #17 in B can be different riders), so the roster is per-class.
// Identity within a class is by start number — the women's GC has no
// independent name list (v1 tradeoff, see issue #8).
